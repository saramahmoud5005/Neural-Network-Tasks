# -*- coding: utf-8 -*-
"""Adaline_Penguins_Classififcation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1DMPkWsCR681WYlbfMEzhZdFDqmmFq9xn
"""
...
def adaline_learing(learning_rate, mse, epochs,is_bias,feature1,feature2,class1,class2):    
  ###load punguins.csv
  dataset=load_data()
  ...
  for e in range(epochs):
    ...
    for xi,yi in zip(X_train,Y_train):
      ...
      a = np.dot(W.T,xi) 
      error = yi - a
      sum_of_errors += 0.5 * pow(error,2)
    
    if (sum_of_errors/m) < mse:
        break
   
  return W,X_train,Y_train,X_test,Y_test

W,X_train,Y_train,X_test,Y_test=adaline_learing(0.01, 0.001, 200,True,'flipper_length_mm','body_mass_g','Adelie','Gentoo') 
